...
def run_model(config, flag='train'):
    ...
    if flag == 'train':
        ...
        model.test('2025_02_24_19_53_55',1)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--enc_in', type=int, default=228, help='encoder input size') # feature dim
    parser.add_argument('--dec_in', type=int, default=228, help='decoder input size') # feature dim
    parser.add_argument('--c_out', type=int, default=228, help='output size')         # feature dim
    ...
    parser.add_argument('--down_sampling_window', type=int, default=3, help='down sampling window size') # 60 -> 30 -> 15
