...
if __name__ == '__main__':
    ...
    parser.add_argument('--target', type=str, default='tps', help='target feature in S or MS task') # txn_elapse, tps
    ...
    parser.add_argument('--enc_in', type=int, default=17, help='encoder input size') # feature dim
    parser.add_argument('--dec_in', type=int, default=17, help='decoder input size') # feature dim
    parser.add_argument('--c_out', type=int, default=17, help='output size')         # feature dim
    ...
    parser.add_argument('--down_sampling_window', type=int, default=2, help='down sampling window size') # 60 -> 30 -> 15
